/*
 * Haushaltsplaner Developer Beta 0.36
 *
 * Diese Version ergänzt die Standard-Rücklagen-Töpfe direkt im Bereich „Töpfe“. Wenn importierte Daten noch keine Töpfe enthalten, werden die fünf Rücklagen-Töpfe Auto, Urlaub, Anschaffungen (inkl. Wohnen), Kleidung und Freizeit automatisch angelegt. Damit ist der Bereich „Töpfe“ sofort nutzbar, auch nach dem Import älterer JSON-Dateien. Die automatische Rücklagen-Verteilung ab Mai 2026 und die Bestätigungsfunktion für gesparte Monate bleiben erhalten.
 */
...
(() => {
    ...
    if (!saved) {
      ...
      for (const k of fallback) {
        ...
        if (data) {
          ...
          localStorage.setItem('budgetStateV037', data);
          break;
        }
      }
    }
  ...
  function saveState() {
    localStorage.setItem('budgetStateV037', JSON.stringify(state));
  }
