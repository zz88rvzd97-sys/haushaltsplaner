/*
 * Haushaltsplaner Developer Beta 0.52
 *
...
(() => {
    ...
    if (!saved) {
      ...
      for (const k of fallback) {
        ...
        if (data) {
          ...
          localStorage.setItem('budgetStateV052', data);
          break;
        }
      }
    }
  ...
  function saveState() {
    localStorage.setItem('budgetStateV052', JSON.stringify(state));
  }
  ...
  function renderSave() {
    ...
    restoreField.appendChild(restoreLabel);
    restoreField.appendChild(importInput);
    restoreWrap.appendChild(restoreField);
    card.appendChild(restoreWrap);
  ...
  if (versionChip) {
    ...
    if (params.has('refresh')) {
      versionChip.textContent = 'Update 0.52 geladen';
      setTimeout(() => {
        versionChip.textContent = 'Version 0.52 geladen';
      }, 2500);
    } else {
      versionChip.textContent = 'Version 0.52 geladen';
    }
